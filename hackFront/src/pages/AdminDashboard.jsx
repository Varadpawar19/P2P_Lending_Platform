        ...
        {isLogoutDialogOpen && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-xl shadow-xl text-center max-w-sm">
              ...
              <p className="mb-5 text-gray-600">Are you sure you want to logout?</p>
              <div className="flex justify-center space-x-4">
                <button
                  onClick={() => {
                    clearCookies();
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex h-screen overflow-hidden">
        {/* Sidebar */}
        <aside
          className={`fixed lg:static w-64 h-full bg-white border-r overflow-y-auto transition-all ${
        ...
        {/* Main Content */}
        <main className="flex-1 overflow-y-auto mt-10 mb-10 p-4">
          {components[activeTab]()}
        </main>
      </div>
    </div>
